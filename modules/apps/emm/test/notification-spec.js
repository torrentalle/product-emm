    ...
    describe('Get Android Operations - Notification Module', function() {
        ...
        it('Test getAndroidOperations for Android', function() {
            ...
            try {
                ...
                var expectResult = JSON.parse('[{"code":"502A","data":[{"messageId":"224124125","data":"hi"}]},{"code":"500P","data":[{"messageId":"224124124","data":[{"code":"507A","data":{"SSID":"WSO2","password":"wso2"}},{"code":"508A","data":{"function":"Disable"}}]}]}]');
    ...
    describe('Get notification operation - Notification Module', function() {
        ...
        it('Test getNotifications', function() {
            try {
                ...
                driver.query("insert into notifications(id, group_id, user_id, device_id, message, status, sent_date, feature_code, feature_description, tenant_id) values ('6', '-1', 'admin@admin.com', '1', '{\"type\" : 1, \"policies\" : [{\"code\" : \"507A\", \"data\" : {\"SSID\" : \"emm_user\", \"password\" : \"emm_user\"}}, {\"code\" : \"508A\", \"data\" : {\"function\" : \"Disable\"}}]}', 'P', '2014-05-07 18:15:08', '501P', 'Policy Monitoring ', '-1234')");
